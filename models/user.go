...
type User struct {
	...
	PhoneDigits *string        `gorm:"size:32;column:phone_digits;index" json:"phone_digits,omitempty"`
...
// BeforeSave hook: ensure PhoneDigits is populated with digits-only representation
